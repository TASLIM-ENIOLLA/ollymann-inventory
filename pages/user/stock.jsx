						...
						<div className = 'col-sm-auto col-12 mb-4 text-center'>
							<div>
								<button onClick = {() => (
									...
									: undefined
								)} className = {`${tablePageData?.pageNumber > 1 ? '' : 'disabled'} rounded transit btn btn-primary py-2 px-3 text-capitalize`}>previous</button>
							</div>
						</div>
						<div className = 'col-sm-auto col-12 mb-4 text-center'>
							<div className = ''>
						...
						<div className = 'col-sm-auto col-12 mb-4 text-center'>
							<div>
								<button onClick = {() => (
									...
									? setDataRows({...dataRows, pageNumber: dataRows.pageNumber + 1})
									: undefined
								)} className = {`${tablePageData?.pageNumber < tablePageData?.maxPages ? '' : 'disabled'} rounded transit btn btn-primary py-2 px-3 text-capitalize`}>next</button>
							</div>
						</div>
					</div>
				</div>
